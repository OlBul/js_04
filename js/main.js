...
function wordsList(str, subStr) {
  ...
  let arr = str.toLowerCase().replace(reg, '').split(' ').filter((elem) => elem.indexOf(subStr) > -1);
...
console.log(getWeekDay('2012-1-5'));
...
const car = new Car('Chevrolet', 'Lacetti', 2000, 2022);
const car2 = new Car('Infinite', 'FX50 AWD', 5000, 2019);
